...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.head.setStyleSheet("background-color: rgb(170,170,170);"
        ...
        # Text Edits
        self.tedit = [QTextEdit("Name 1"), QTextEdit("Name 2"), QTextEdit("Name 3"), QTextEdit("Name 3")]
        for n in range(4):
